    ...
    public function getListSwatchHtml($_attributes, $productId)
    {
		...
		foreach($_attributes as $_attribute):
			...
			if(in_array($_attribute['attribute_code'], $swatch_attributes)):
				...
				$html .= '<form><input type="hidden" id="hidden-thecolor-'.$productId.'" value=" " /></form>';
				...
				foreach($_attribute['values'] as $value):
					...
					if (count($matches[0]) > 0):
						...
						if( $colorsel == $theId)  $sku = $child->getSku();
							...
							$html = $html."(this,'".$productId."','".$product_image."','".$attrid."' ,'".$sku."','".$altText."')";
							$html = $html.'" />';
						...
						if( $colorsel == $theId)  $sku = $child->getSku();
							...
							$html .= "this,'".$productId."','".$product_image."','".$attrid."','".$attrid."','".$sku."','".$altText."');";
