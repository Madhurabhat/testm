 ...
 * File path:   app/code/local/Aitoc/Aitcheckout/controllers/PaymentController.php
...
if (Mage::helper('aitcheckout')->checkIfEbizmartsSagePaySuiteActive() && is_file($ebizmartsControllerFile))
{
